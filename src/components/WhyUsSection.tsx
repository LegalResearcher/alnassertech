...
const features = [
  {
    ...
    description: "موقعك مبني ليحمّل بسرعة فعليًا، وهو ما ينعكس على ترتيبه في نتائج Google وعلى بقاء الزائر بدل مغادرته.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    description: "أسعار تنافسية تكسر حاجز البداية، بباقات واضحة تناسب كل حجم مشروع دون تضحية بالجودة.",
  },
  {
    icon: Headphones,
    title: "شريكك 24/7",
