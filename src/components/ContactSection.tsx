    ...
    <section id="contact" className="py-24 hero-gradient relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-plex text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground mb-6">
            لنتحدث عن مشروعك
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            أخبرنا عن فكرتك أو المشكلة التي تواجهها في موقعك الحالي، ونعود إليك برأي واضح
            <br />
            <span className="text-primary-foreground font-semibold">قبل أي التزام.</span>
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center p-10 rounded-3xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 backdrop-blur-sm">
            ...
            <h3 className="font-plex text-2xl md:text-3xl font-bold text-primary-foreground mb-4">
              تفضّل التواصل المباشر؟
            </h3>
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              راسلنا على واتساب لاستشارة أولية حول مشروعك، بلا التزام
            </p>
            <Button
              variant="whatsapp"
              size="lg"
